...
<head>
    ...
    <style>
        ...
        @media (prefers-color-scheme: dark) {
            .dark-bg {
                background-color: #233632 !important;
            }
            ...
            .dark-muted {
                color: #f5c5b7 !important;
            }
        }
    </style>
</head>

<body style="margin:0; padding:0; background:#f3f9f5; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" class="dark-bg"
        style="background: linear-gradient(180deg, #f3f9f5 0%, #f5c5b7 100%); min-height:100vh;">
        <tr>
            <td align="center" style="padding:40px 15px;">
                ...
                <table role="presentation" class="email-container animated-card" width="600" cellpadding="0"
                    ...
                    <tr>
                        <td style="height:6px; background: linear-gradient(90deg, #41a79c, #f36a49, #ee4820, #41a79c); background-size: 300% 100%; animation: shimmer 3s ease-in-out infinite;"></td>
                    </tr>

                    <tr>
                        <td style="padding:0;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
                                style="background: linear-gradient(135deg, #2f3d39 0%, #41a79c 50%, #c95742 100%);">
                                <tr>
                                    <td style="padding:32px 40px; text-align:center;">
                                        <p style="margin:0 0 4px 0; font-size:26px; font-weight:800; color:#FFFFFF; letter-spacing:1px;">
                                            House of Quran Academy
                                        </p>
                                        <p style="margin:0; font-size:13px; color:#f3f9f5; font-weight:400; letter-spacing:2px; text-transform:uppercase;">
                                            ${isAr ? "منصة تعليم القرآن الكريم بإتقان واهتمام" : "Quran Learning with Care and Excellence"}
                                        </p>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding:20px 48px 36px 48px;">
                                ...
                                <tr>
                                    <td align="center">
                                        <div style="
                                            width:90px; 
                                            height:90px; 
                                            background: linear-gradient(145deg, #f3f9f5, #f5c5b7);
                                            border-radius:22px; 
                                            box-shadow: 0 10px 25px -5px rgba(65, 167, 156, 0.3), inset 0 1px 0 rgba(255,255,255,0.8);
                                            text-align:center;
                                            line-height:90px;
                                        ">
                                            <span style="font-size:42px;">📖</span>
                            ...
                            <p style="margin:0 0 8px 0; font-size:15px; color:#41a79c; font-weight:600; text-transform:uppercase; letter-spacing:1.5px; text-align:center;">
                                ${otp ? (isAr ? "مطلوب التحقق" : "Verification Required") : (isAr ? "مرحباً!" : "Hello!")}
                            </p>

                            <h1 style="margin:0 0 16px 0; font-size:30px; line-height:1.3; color:#2f3d39; font-weight:800; text-align:center; letter-spacing:-0.5px;">
                                ${displayTitle}
                            </h1>

                            <p style="margin:0 0 28px 0; font-size:16px; line-height:1.7; color:#6f7f79; text-align:center;">
                                ${isAr ? "مرحباً" : "Hi"} <strong style="color:#2f3d39;">${username}</strong>,
                                ${otp ? (isAr ? "لقد تلقينا طلباً للتحقق من حسابك في الأكاديمية. استخدم الرمز أدناه للمتابعة:" : "we received a request to verify your House of Quran Academy account. Use the code below to continue:") : (isAr ? "شكراً لوجودك معنا في House of Quran Academy." : "thank you for being with House of Quran Academy.")}
                            </p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0 auto 24px auto;">
                                <tr>
                                    <td align="center">
                                        <div style="background: linear-gradient(145deg, #ffffff, #f3f9f5); border-radius:20px; padding:28px 20px; border: 1px solid #f5c5b7;">
                                            ...
                                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:18px auto 0 auto;">
                                                <tr>
                                                    <td style="background: linear-gradient(135deg, #f5c5b7, #f5845a); padding:8px 16px; border-radius:50px;">
                                                        <span style="font-size:13px; color:#7a3d31; font-weight:600;">
                                                            ${isAr ? "⏱️ تنتهي الصلاحية خلال 10 دقائق" : "⏱️ Expires in 10 minutes"}
                                                        </span>
                                                    </td>
                                                </tr>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0 auto 20px auto;">
                                <tr>
                                    <td style="background: #fff4ef; border-radius:12px; padding:16px 20px; border-left:4px solid #ee4820;">
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td style="padding-right:12px;">
                                                    <span style="font-size:20px;">🛡️</span>
                                                ...
                                                <td>
                                                    <p style="margin:0; font-size:13px; color:#8f2e1a; line-height:1.5; font-weight:500;">
                                                        <strong>${isAr ? "نصيحة أمان:" : "Security Tip:"}</strong> ${isAr ? "لا تشارك هذا الرمز مع أي شخص أبداً. فريقنا لن يطلب منك رمز التحقق الخاص بك." : "Never share this code with anyone. Our team will never ask for your verification code."}
                                                    </p>
                                                </td>
                                            </tr>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0 auto 20px auto;">
                                <tr>
                                    <td style="background: linear-gradient(145deg, #f3f9f5, #e5f4ee); border-radius:16px; padding:24px; border:1px solid #b9ded8;">
                                        <p style="margin:0; font-size:15px; color:#28746b; line-height:1.7; text-align:center;">
                                            ${text}
                                        </p>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding:0 48px 36px 48px;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td width="33%" style="text-align:center; padding:0 8px;">
                                        <div style="background:#f3f9f5; border-radius:14px; padding:20px 12px;">
                                            <span style="font-size:28px;">🤲</span>
                                            <p style="margin:10px 0 0 0; font-size:12px; color:#28746b; font-weight:600;">
                                                ${isAr ? "ثقة" : "Trusted"}
                                            </p>
                                        </div>
                                    </td>
                                    ...
                                    <td width="33%" style="text-align:center; padding:0 8px;">
                                        <div style="background:#fff4ef; border-radius:14px; padding:20px 12px;">
                                            <span style="font-size:28px;">🌙</span>
                                            <p style="margin:10px 0 0 0; font-size:12px; color:#c95742; font-weight:600;">
                                    ...
                                    <td width="33%" style="text-align:center; padding:0 8px;">
                                        <div style="background:#f5c5b7; border-radius:14px; padding:20px 12px;">
                                            <span style="font-size:28px;">📖</span>
                                            <p style="margin:10px 0 0 0; font-size:12px; color:#bb7165; font-weight:600;">
                    ...
                    <tr>
                        <td style="padding:0 48px;">
                            <div style="height:1px; background: linear-gradient(90deg, transparent, #f5c5b7, transparent);"></div>
                        </td>
                    </tr>

                    <tr>
                        <td style="height:6px; background: linear-gradient(90deg, #41a79c, #f36a49, #ee4820, #41a79c); background-size: 300% 100%;"></td>
                    </tr>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:24px auto 0 auto;">
                    <tr>
                        <td align="center">
                            <p style="margin:0; font-size:11px; color:#bb7165;">
                                ${isAr ? "مرسل من" : "Sent by"} <strong style="color:#41a79c;">House of Quran Academy</strong>
                            </p>
                        </td>
                    </tr>
                </table>
