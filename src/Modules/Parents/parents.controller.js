  ...
  const parentsData = await Promise.all(
    parents.map(async (parent) => {
      ...
      return {
        ...
        name: parent.name,
        email: parent.email,
        password: await decryptPassword({ password: parent.password }),
        phone: phone,
...
export const createParent = asyncHandler(async (req, res, next) => {
  ...
  return successResponse({
    ...
    data: {
      ...
      password: await decryptPassword({ password: createdParent.password }),
...
export const updateParent = asyncHandler(async (req, res, next) => {
  ...
  return successResponse({
    ...
    data: {
      ...
      password: await decryptPassword({ password: parentDetails.password }),
      phone: phoneDecrypted,
